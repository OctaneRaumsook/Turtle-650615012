...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        //** Setting up each colour */
        Turtle A = new Turtle(-250, 200);
        Turtle B = new Turtle(-250, 180);
        Turtle C = new Turtle(-250, 160);
        Turtle D = new Turtle(-250, 140);
        Turtle E = new Turtle(-250, 120);
        Turtle F = new Turtle(-250, 100);
        A.penColor("red");
        A.width(20);
        A.speed(2);
        B.penColor("orange");
        ...
        F.speed(2);
        //** */
        for(int i=0;i<50;i++) // Draw pride month flag
        {
        ...
        Turtle prideOne = new Turtle(-220,-70);
        Turtle prideTwo = new Turtle(-120,-70);
        Turtle prideThree = new Turtle(-20,-70);
        Turtle prideFour = new Turtle(60,-70);
        Turtle prideFive = new Turtle(200,-70);

        prideOne.penColor("purple");
        prideOne.width(10);
        prideOne.speed(2);
        prideTwo.penColor("purple");
        prideTwo.width(10);
        prideTwo.speed(2);
        prideThree.penColor("red");
        prideThree.width(10);
        prideThree.speed(2);
        prideFour.penColor("purple");
        prideFour.width(10);
        prideFour.speed(2);
        prideFive.penColor("purple");
        prideFive.width(10);
        prideFive.speed(2);

        prideOne.setPosition(-220,50);
        for(int i=0;i<90;i++)
        {
            prideOne.right(2);
            prideOne.forward(1);
        ...
        prideTwo.setPosition(-120,50);
        for(int i=0;i<90;i++)
        {
            prideTwo.right(2);
            prideTwo.forward(1);
        }
        prideTwo.setDirection(0);
        prideTwo.right(60);
        for(int i = 0; i<72; i++)
        {
            prideTwo.forward(1);
        ...
        prideThree.setDirection(90);
        for(int i =0; i<120; i++)
        {
            prideThree.forward(1);
        }
        

        prideFour.setPosition(60, 50);
        for(int i=0;i<180;i++)
        {
            prideFour.right(1);
            prideFour.forward(1);
        ...
        for(int i=0; i<280; i++)
        {
            ...
            {
                prideFive.setDirection(90);
            }
            else if(i==100 || i==240)
            {
                prideFive.setDirection(0);
            }
